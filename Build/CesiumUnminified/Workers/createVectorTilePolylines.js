define(['./Matrix3-51afcfcb', './combine-6eb6e848', './AttributeCompression-ec6d27e6', './Math-f7bd710c', './IndexDatatype-086e75a1', './Matrix2-3a8613cf', './createTaskProcessorWorker', './Check-e01dbea3', './defaultValue-040c41f9', './ComponentDatatype-614bb7b9', './WebGLConstants-f7267ced', './RuntimeError-3c5db370'], (function (Matrix3, combine, AttributeCompression, Math, IndexDatatype, Matrix2, createTaskProcessorWorker, Check, defaultValue, ComponentDatatype, WebGLConstants, RuntimeError) { 'use strict';
